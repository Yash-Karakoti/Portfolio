export const myProjects = [
  {
    ...
    title: "AlgoBotX",
    description:
      "AI powered Assistant for Algorand Developers, Built for real time guidance on smart contracts, blockchain interactions and ecosystem tools.",
    subDescription: [
      "1. You can ask any Algorand related Query",
      "2. Can send Testnet ALGO Tokens for Testnet Development",
      "3. A Discord bot which can be added to any discord server",
      "4. AI Powered Smart Contract Debugger.",
      "5. Users can attempt Quizzes according to their level.",
    ],
    href: "",
    logo: "",
    image: "/assets/projects/Algobotx.jpg",
    tags: [
      {
        id: 1,
        name: "Python",
      ...
      },
      {
        id: 2,
        name: "Discord.py",
        path: "/assets/logos/discord.py.png",
      },
      {
        id: 3,
        name: "AlgoKit",
        path: "/assets/logos/algorand.png",
      },
      {
        id: 4,
        name: "Codespaces",
        path: "/assets/logos/GithubCodespaces.svg",
      },
    ],
  },
  {
...
export const mySocials = [
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/in/YashKarakoti/",
    icon: "/assets/socials/Linkedin.svg",
  },
  {
    name: "Twitter",
    href: "https://www.x.com/YashKarakoti8",
    icon: "/assets/socials/x.svg",
  },
  {
    name: "Reddit",
    href: "https://www.reddit.com/user/trash_divine/",
  ...
  {
    name: "Github",
    href: "https://github.com/Yash-Karakoti",
...
export const experiences = [
  ...
  {
    title: "Algorand Blockchain Club, MUIT",
    job: "Team Member",
    date: "2023-2027",
    contents: [
